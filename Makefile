...
clean: #cleans all the old compilation files
	@rm -f namelist.mod write_read_data.mod degree_to_radian.mod mass_flux.mod da_da.mod div_m.mod height_of_slab.mod other_fluxes.mod matrix_calc.mod test.mod *.o ULMO
